...
/*
Berisikan Helper code untuk menuliskan response dari Response dan ErrResponse struct dengan bantuan chi
Lebih bagus untuk memisah kode dalam beberapa file
*/
type HTTPErr struct {
	Err  error
	Code int
